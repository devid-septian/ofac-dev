            ...
            <div className="content-wrapper report-data">
              <Card>
                ...
                <div className="search-form">
                  ...
                  <Form.Label>Start <span>*</span></Form.Label>
                  <Form.Group className="" controlId="dataForm.ControlInputAccount">
                    <Form.Control type="text" />
                  </Form.Group>
                  </div>
                  <div className="form-date">
                  <Form.Label>End <span>*</span></Form.Label>
                  <Form.Group className="" controlId="dataForm.ControlInputAccount">
                    <Form.Control type="text" />
                  </Form.Group>
                  </div>
                  ...
                  <Table striped>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Positive Match</td>
                        <td>Data Detail</td>
                        <td><Button variant="success"><FileDownloadIcon /></Button></td>
                      </tr>
                      <tr>
                        <td>Extract Date</td>
                        <td>Ofac List</td>
